            ...
            <div class="col-xl-12 margin-bottom-30">
                <div class="row">
                    <div class="col-md-7 col-sm-12">
                        ...
                        <div class="post-head">{{ ucfirst($listing->job_title) }} @if($listing->immediate_assistance == 'required')<i class="icon-feather-radio red"></i> @endif</div>
                        ...
                        <div class="job-overview">
                            ...
                            <div class="job-overview-inner">
                                <ul>
                                    <li>
                                        <span>Posted by</span>
                                        <h5 class="post-client"><a href="#user-profile">{{ $listing->user->first_name }} {{ $listing->user->last_name }}</a></h5>
                                    </li>
                                    <li>
            ...
            <div class="col-xl-8 col-lg-8">
                ...
                <div class="single-page-section">
                    ...
                    @if($listing->immediate_assistance == 'required')
                        <div class="margin-top-10 immediate-assistance"><i class="icon-feather-radio red"></i> Immediate Assistance Required</div>
                    @endif
                </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            @forelse($listing->budgetDetails as $budgetDetail)
                                <div class="post-milestone"><span class="milestone-price">${{ $budgetDetail->budget }}</span> {{ $budgetDetail->date_time->format('D, F dS, Y - H:ia') }}</div>
                            @empty
                            @endforelse
                        </div>
                ...
                <div class="single-page-section">
                    ...
                    <div class="attachments-container">
                        ...
                        <a href="{{ asset('storage/listing-files/'.$attachment->file_name.'.'.$attachment->file_format) }}" target="_blank" class="attachment-box ripple-effect"><span>{{ $attachment->file_name }}</span><i>{{ strtoupper($attachment->file_format) }}</i></a>
                        @empty
                        @endforelse
                    </div>
                    <div class="row margin-top-20">
                        <div class="col-12 my-gallery" itemscope itemtype="http://schema.org/ImageGallery">
                            ...
                            <figure itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
                                <a href="{{ asset('storage/listing-files/'.$img->file_name.'.'.$img->file_format) }}" itemprop="contentUrl" data-size="1024x1024">
                                    <div class="photoswipe-container"><img src="{{ asset('storage/listing-files/'.$img->file_name.'.'.$img->file_format) }}" /></div>
                                </a>
                            </figure>
                            @empty
                            @endforelse
