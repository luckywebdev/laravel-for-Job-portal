...
<div class="tabs margin-bottom-30">
    <div class="tabs-header tabs-white-bg tabs-single-border pure-menu pure-menu-horizontal pure-menu-scrollable">
        <a href="{{ route('front.home') }}" class="pure-menu-heading">taskapron</a>
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        <div class="submit-field">
                                            ...
                                            <select class="selectpicker margin-bottom-0" name="category" id="categoryID" data-size="7" title="Select Category" data-live-search="true">
                        ...
                        <div class="row">
                                <div class="col-12">
                                    <div class="custom-input material">
                                        ...
                                        <input id="title" name="title" value="{{ $key  ?? '' }}" class="custom-focus custom-input-reset custom-input-border"></input>
                                ...
                                <div class="col-12 margin-top-20">
                                    <div class="custom-input material">
                                        ...
                                        <textarea id="description" name="description" class="custom-focus custom-input-reset custom-textarea custom-input-border"></textarea>
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="custom-radio">
                                        ...
                                        <div class="radio custom-radio-">
                                            <input id="radio-1" value="included_in_budget" name="materials" type="radio" checked>
                                            <label for="radio-1"><span class="radio-label"></span>@lang('core.includedBudget') </label>
                                        </div>
                                        <br>
                                        <div class="radio custom-radio-">
                                            <input id="radio-2" value="not_required" name="materials" type="radio">
                                            <label for="radio-2"><span class="radio-label"></span>@lang('core.noneRequired')</label>
                                        </div>
                                        <br>
                                        <div class="radio custom-radio-">
                                            <input id="radio-3" value="not_included"  name="materials" type="radio">
                            ...
                            <div class="ow-inner-container">
                                ...
                                <div class="row">
                                    <div class="col-md-4 col-sm-6">
                                        ...
                                        <input class="posting-date" id="date_time" name="date_time" data-timepicker="true" data-time-format='hh:ii aa' placeholder="@lang('messages.dateTimeTitle')"></input>
                                    </div>
                                    <div class="col-md-8 col-sm-6 center-vertical">
                            ...
                            <div class="row margin-top-20">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    <div class="row margin-top-30" id="detailBudget">
                                        <input type="hidden" name="budgetValue[]" value="0">
                                        <input type="hidden" name="budgetDate[]" value="0">
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="submit-field">
                                            ...
                                            <select class="selectpicker" name="job_location" title="@lang('messages.ChooseLocation')">
                                                <option data-subtext="on_location" value="on_location">@lang('core.onSite')</option>
                                                <option data-subtext="online" value="online">@lang('core.remote')</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-sm-6 center-vertical">
                                ...
                                <div class="col-md-8 col-sm-12">
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <div class="account-type">
                                            <div>
                                                <input type="radio" value="not_required" name="immediate_assistance" id="freelancer-radio" class="account-type-radio" checked/>
                                            ...
                                            <div>
                                                <input type="radio" value="required" name="immediate_assistance" id="employer-radio" class="account-type-radio"/>
                            ...
                            <div class="row margin-bottom-50">
                                <div class="col-12">
                                    <div class="custom-input material">
                                        ...
                                        <input id="gmap_geocoding_address" name="address" class="custom-focus custom-input-reset custom-input-border" placeholder="" onFocus="geolocate()">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <div class="custom-input material">
                                        ...
                                        <input id="street_address" name="street_address" class="custom-focus custom-input-reset custom-input-border">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="custom-input material">
                                        ...
                                        <input id="city1" name="city" class="custom-focus custom-input-reset custom-input-border">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="custom-input material">
                                        ...
                                        <input id="state1" name="state" class="custom-focus custom-input-reset custom-input-border">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    <div class="custom-input material">
                                        ...
                                        <input id="postal_code" name="zip" class="custom-focus custom-input-reset custom-input-border">
                ...
                <div class="tab" data-tab-id="4">
                                    ...
                                    <div class="col-md-4 col-sm-6">
                                        <div class="submit-field">
                                            ...
                                            <select class="selectpicker" name="term_condition" onchange="checkButton(this.value)" title="@lang('messages.selectTerm')">
                                                <option value="agree">@lang('messages.iAgree')</option>
                                                <option value="disagree">@lang('messages.iDisAgree')</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-8 col-sm-6 center-vertical">
                    ...
                    <section class="section-container">
                        ...
                        <div class="row margin-top-50">
                            <div class="col-12">
                                <a href="javascript:;" onclick="submitForm(); return false;" class="button button-sliding-icon ripple-effect pull-right ASDFAD">@lang('core.postListing') <i class="icon-material-outline-arrow-right-alt"></i></a>
                            </div>
                        </div>
                    </section>
                </div>
...
<script>
    ...
    $(function() {
        ...
        @if($catID)
            $('#categoryID').val({!! json_encode($catID)  !!});
