...
<div class="left-side">
    ...
    <nav id="navigation">
        <ul id="responsive">
            ...
            <li><a href="{{ route('user.listing.create') }}"><i class="icon-feather-upload-cloud blue-icon"></i> Post a Job</a>
            </li>
                                ...
                                <li class="notifications-not-read">
                                    <a href="{{ route('user.message.index') }}">
                                        ...
                                        <div class="notification-text">
                                            <strong>{{ $unseenMessage->fromUser->first_name . ' ' . $unseenMessage->fromUser->last_name }}:</strong>
...
{{--                                            {!! strpos($unseenMessage->message, 'Offer From') ? 'Offer Received' : $unseenMessage->message !!}--}}
                ...
                <a href="{{ route('user.message.index') }}" class="header-notifications-button ripple-effect button-sliding-icon">View All Messages<i class="icon-material-outline-arrow-right-alt"></i></a>
            </div>
        </div>
            ...
            <div class="header-notifications-dropdown">
                ...
                <div class="user-status">
                    ...
                    <div class="user-details">
                        ...
                        <div class="user-name">
                            {{ ucwords($user->full_name) }} <span>Freelancer</span>
                        </div>
                    </div>
                ...
                <ul class="user-menu-small-nav">
                    <li><a href="{{ route('user.dashboard.index') }}"><i class="icon-material-outline-dashboard"></i> Dashboard</a></li>
