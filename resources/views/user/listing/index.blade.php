        ...
        <div class="tabs">
            <div class="tabs-header tabs-white tabs-bottom-border tabs-single-border">
                <ul class="tabs-jobs-group tabs-jobs-icons">
                    <li class="active ripple-effect-dark"><a href="#tab-1" data-tab-id="1"><i class="icon-feather-map-pin"></i> Active</a></li>
                    <li class="ripple-effect-dark"><a href="#tab-2" data-tab-id="2"><i class="icon-feather-map-pin"></i> Assigned</a></li>
                    <li class="ripple-effect-dark"><a href="#tab-3" data-tab-id="3"><i class="icon-feather-tag"></i> My Bids</a></li>
                    <li class="ripple-effect-dark"><a href="#tab-4" data-tab-id="4"><i class="icon-feather-pocket"></i> Completed</a></li>
                    <li class="ripple-effect-dark"><a href="#tab-5" data-tab-id="5"><i class="icon-feather-refresh-cw"></i> Ended</a></li>
                </ul>
            ...
            <div class="tabs-content tabs-no-space">
                <div class="tab active" data-tab-id="1">
                    ...
                    <div class="row tabs-jobs-border tabs-jobs-padding">
                        ...
                        @empty
                            <div class="margin-left-30 p-15">No Listing found!</div>
                        @endforelse
                    </div>
                                    ...
                                    <div class="col-6 pull-right">
                                        <div class="tabs-jobs-buttons">
                                                @if($listing->checkCompleted())
                                                    ...
                                                    <a href="javascript:;" onclick="sendMessage('{{ $listing->offer_user_id }}', '{{ $listing->id }}', 'open')" class="popup-with-zoom-anim button gray ripple-effect ico" title="Contact Freelancer" data-tippy-placement="top"><i class="icon-feather-message-square"></i></a>
                ...
                <div class="tab" data-tab-id="5">
                    ...
                    <div class="row tabs-jobs-border tabs-jobs-padding">
                        @forelse($endedListings as $listing)
                            <div class="col-12" id="listingRow{{ $listing->id }}">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="job-listing-title">
...
@section('footerjs')
    ...
    <script>
        ...
        function deleteList(id){
            listingId = id;
            var url = "{{ route('user.listing.destroy',':id') }}";
            url = url.replace(':id', id);
            $.easyAjax({
                url: url,
                type: "Delete",
