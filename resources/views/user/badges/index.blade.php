...
@section('content')
    ...
    <div class="dashboard-headline">
        <h3>Bookmarks
            <span class="icon-feather-info" data-tippy-placement="right" title="Licenses must be updated every year on Jan. 1. You are responsible for insuring a valid license upon hire."></span>
        </h3>
            ...
            <div class="tabs">
                <div class="tabs-header tabs-white tabs-bottom-border tabs-single-border">
                    <ul class="tabs-jobs-group tabs-jobs-icons">
                        <li class="active ripple-effect-dark"><a href="#" data-tab-id="1"><i class="icon-feather-book-open"></i> Verification Badges</a></li>
                        <li class="ripple-effect-dark"><a href="#" data-tab-id="2"><i class="icon-feather-book-open"></i> Licensed Badges</a></li>
                    </ul>
