        ...
        <div class="crate-inner add-radius add-shadow add-white crate-padding crate-hover">
            <div class="row margin-bottom-15">
                <div class="col-12">
                    ...
                    <div class="modal-head- blue-icon"><i class="icon-feather-user"></i> {{ $listing->offers->user->full_name }}</div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <a href="javascript:;" onclick="sendMessage('{{ $listing->offers->user_id }}', '{{ $listing->id }}', 'open')" class="popup-with-zoom-anim button gray ripple-effect modal-button full-width">Contact</a>
                </div>
            </div>
        </div>
    </div>
