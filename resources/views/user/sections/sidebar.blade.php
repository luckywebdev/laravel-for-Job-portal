            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    ...
                    <ul>
                        ...
                        <li><a href="{{ route('user.review.index') }}"><i class="icon-material-outline-rate-review"></i> Reviews</a></li>
                    </ul>

                    <ul>
                        <li><a href="{{ route('user.listing.index') }}"><i class="icon-material-outline-business-center"></i> Jobs</a></li>
