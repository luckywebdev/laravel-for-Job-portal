...
Route::group(['namespace' => 'User', 'middleware' => ['auth.user', 'web'], 'prefix' => ''], function () {
    ...
    Route::post('listing-upload-files', ['uses' => 'ListingController@uploadFiles', 'as' => 'listing.file-upload']);
    Route::post('listing-delete-files', ['uses' => 'ListingController@deleteFile', 'as' => 'listing.deleteFile']);
    ...
    Route::get('listing-delete/{listing}', ['uses' => 'ListingController@deleteListing', 'as' => 'listing.delete-listing']);
